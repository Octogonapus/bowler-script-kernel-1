    ...
    if (capture.isOpened()) {
      while (true) {
        ...
        if (!webcam_image.empty()) {
          ...
          Core.line(webcam_image, new Point(150, 50), new Point(202, 200), new Scalar(100, 10,
              10)/*CV_BGR(100,10,10)*/, 3);
          ...
          if (data2.length > 0) {
            ...
            for (int i = 0; i < data2.length; i = i + 3) {
              ...
              //Core.ellipse( this, center, new Size( rect.width*0.5, rect.height*0.5), 0, 0,
              // 360, new Scalar( 255, 0, 255 ), 4, 8, 0 );
              Core.ellipse(webcam_image, center, new Size((double) data2[i + 2], (double) data2[i
                  + 2]), 0, 0, 360, new Scalar(255, 0, 255), 4, 8, 0);
            }
          }
          Core.line(hsv_image, new Point(150, 50), new Point(202, 200), new Scalar(100, 10, 10)
              /*CV_BGR(100,10,10)*/, 3);
          ...
          Core.line(distance, new Point(150, 50), new Point(202, 200), new Scalar(100)/*CV_BGR
          (100,10,10)*/, 3);
